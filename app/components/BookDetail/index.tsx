					...
					<div className="col-md-12">
						<div className="row">
							<div className="col-md-12">
								...
								<span className="text-primary py-1 book-author d-block"></span>

								<strong className="m-2">Editorial: </strong>
								<span className="text-primary py-1 d-block">SIN FRONTERAS</span>

								<strong className="m-2">Páginas: </strong>
								<span className="py-1 book-pages d-block"></span>
							</div>
						</div>
